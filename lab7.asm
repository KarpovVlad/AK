...
DATASEG
	...
	menu_02 db "Press l to calculate",13,10,'$'
	menu_03 db "Press Z to beep",13,10,'$'
 	menu_04 db "Press t to find the lowest number",13,10,'$' 
	menu_05 db "Press x to exit",13,10,'$'
	menu_06 db "------------------------------------",13,10,'$'
	exit_mes db "Fin",13,10,'$'
...
; Призначення: знаходження найменшого значення
; Вхід: -
; Вихід: -
PROC lo
; Вивід даних
